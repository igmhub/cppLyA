...
int cp(const char *path1, const char *path2, const bool Warn=true);
...
void Replace(string &string_to_be_modified,const string &element_to_replace , const string &by_this); 
